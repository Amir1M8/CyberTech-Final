...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2026 at 07:44 AM
...
(2, 'Arrival Machine', 'Simulates a multi-service server where port discovery, service fingerprinting, and misconfigured services are the main challenges. Ideal for network scanning and hardening practice.', 'Network, Services, Misconfiguration', 'Intermediate–Advance', '../../assets/images/machines/arrival.jpeg', '#Arrival'),
...
(4, 'Escape the Matrix', 'An internal administration system with complex access controls and information disclosure issues. Emphasizes privilege escalation and in-depth access auditing.', 'Access Control, Information Disclosure, Privilege Escalation', 'Intermediate–Advance', '../../assets/images/machines/matrix.jpeg', '#Matrix'),
(5, 'Pgnix Machine', 'A machine for binary analysis and exploit development practice (includes challenges like hardened buffer overflows). Built for those starting with reverse engineering and safe exploitation techniques.', 'Binary Analysis, RE, Memory Exploitation', 'Advanced', '../../assets/images/machines/pgnix.jpeg', '#Pgnix'),
...
CREATE TABLE `users` (
  ...
  `description` varchar(200) NOT NULL DEFAULT 'Empty',
  `user_status` varchar(10) NOT NULL DEFAULT 'Member',
  `picture` varchar(300) NOT NULL DEFAULT '../../assets/images/users.jpeg',
  `skills` varchar(500) NOT NULL DEFAULT 'Empty'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `description`, `user_status`, `picture`, `skills`) VALUES
(1, 'admin', 'admin123', 'admin@gmail.com', 'CyberTech Admin - Professional VIP USER', 'isAdmin', '../../assets/images/upload/users/admin_profile.jpeg', 'Web Pentester, Network Manager, Hacker'),
(3, 'Mamot', 'MamadHero', 'mamad2026@gmail.com', 'من ممدم', 'Member', '../../assets/images/upload/users/Mamad_1688655138126-103a8.jpeg', 'Hacker');
